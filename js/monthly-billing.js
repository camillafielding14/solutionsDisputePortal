...
function generateBillingInfo() {
    ...
    if (saleType === "office") {
        ...
        if (verifyVideo === "yes") {
            saleDetails = `and they acknowledged by initialing, signing, and verbally agreeing in a video`;
        } else {
            saleDetails = `and they acknowledged by initialing, signing, and agreeing`;
        }
    }
